...
export const GDPR: React.FC<GDPRProps> = ({ handleOnClose }) => {
  return (
    <div className="backdrop-blur-sm" onClick={handleOnClose}>
      <h4>Privacy Policy</h4>

      <p>
        We are very delighted that you have shown interest in our enterprise.
        Data protection is of a particularly high priority for the management of
        the øhr. The use of the Internet pages of the øhr is possible without
      ...
      <p>
        ...
        øhr. By means of this data protection declaration, our enterprise would
      ...
      <p>
        As the controller, the øhr has implemented numerous technical and
      ...
      <h4>1. Definitions</h4>
      <p>
        The data protection declaration of the øhr is based on the terms used by
      ...
      <p>Berlin</p>
      <p>Germany</p>
      <p>Email: ohr.xyz.sol@gmail.com</p>
      <p>Website: www.ohr.nfts</p>

      <h4>3. Collection of general data and information</h4>
      <p>
        The website of the øhr collects a series of general data and information
      ...
      <p>
        When using these general data and information, the øhr does not draw any
        ...
        cyber-attack. Therefore, the øhr analyzes anonymously collected data and
      ...
      <p>
        The website of the øhr contains information that enables a quick
      ...
      <ul className="list-style: none;">
        ...
        <li>
          ...
          <p>
            ...
            wishes to request the erasure of personal data stored by the øhr, he
            or she may, at any time, contact any employee of the controller. An
            employee of øhr shall promptly ensure that the erasure request is
          ...
          <p>
            ...
            as processing is not required. An employees of the øhr will arrange
        ...
        <li>
          ...
          <p>
            ...
            stored by the øhr, he or she may at any time contact any employee of
            the controller. The employee of the øhr will arrange the restriction
            of the processing.{" "}
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            may at any time contact any employee of the øhr.
          </p>
        </li>
        <li>
          ...
          <p>
            The øhr shall no longer process the personal data in the event of
          ...
          <p>
            If the øhr processes personal data for direct marketing purposes,
            ...
            øhr to the processing for direct marketing purposes, the øhr will no
          ...
          <p>
            ...
            data concerning him or her by the øhr for scientific or historical
          ...
          <p>
            ...
            contact any employee of the øhr. In addition, the data subject is
        ...
        <li>
          ...
          <p>
            ...
            consent, the øhr shall implement suitable measures to safeguard the
          ...
          <p>
            ...
            contact any employee of the øhr.
          </p>
        </li>
        <li>
      ...
      <p>
        ...
        <a href="https://abletocontract.com/">sign pdf free</a>. The legal texts
        contained in our privacy policy generator have been provided and
        published by{" "}
